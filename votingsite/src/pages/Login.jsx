        ...
        <div className="relative sm:max-w-xl sm:mx-auto">
          <div className="relative px-4 py-10 bg-black mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
            <div className=" flex justify-between">
              <p className=" text-xl font-serif">Login as Admin</p>{" "}
              <p className=" text-2xl">OR</p>
              <button className=" bg-green-200 rounded-xl p-2 text-gray-800 font-serif hover:bg-green-500">
                <Link to={"/voterlog"}>Login as Voter</Link>
              </button>
            </div>
            <div className="max-w-md mx-auto text-white">
              <div className="flex items-center justify-center">
                <h1 className=" text-4xl">
                  <b className=" text-5xl font-display text-pink-400">L</b>ogin
                </h1>
                {/* <svg
                fill="none"
                viewBox="0 0 397 94"
              ...
              <div className="text-right mb-4">
                <p className="text-s mb-5 font-semibold text-gray-500 hover:text-gray-400 cursor-pointer">
