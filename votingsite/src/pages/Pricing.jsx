...
export default function Pricing() {
  return (
    <div className='bg-white'>
      ...
      <p className='text-4xl text-center font-serif font-semi-bold underline text-gray-500'>Choose What Suits You</p>
      <div className='flex flex-col md:flex-row mx-5 md:mx-32 py-8 md:py-16 gap-8 md:gap-12'>
        <Pricingc title={'Starters'} body={'Trial pack organize upto 5 Elections'} cost={'0$'} />
        <Pricingc title={'Beginners'} body={'Absolute Beginner Pack 20 Elections'} cost={'10$'} />
        <Pricingc title={'Plus'} body={'Plus Pack, Organize upto 50 Elections'} cost={'30$'} />
      </div>
      <div className='flex flex-col md:flex-row mx-5 md:mx-32 py-8 md:py-16 gap-8 md:gap-12'>
        <Pricingc title={'Plus++'} body={'Customized Ballot & 100 elections'} cost={'50$'} />
        <Pricingc title={'Monthly'} body={'Get unlimited Election For a month'} cost={'100$'} />
        <Pricingc title={'Annual'} body={'Unlimited Access to all the features'} cost={'200$'} />
      </div>
