...
const Votingbox = () => {
  ...
  const handleVote = async (candidateId) => {
    try {
      ...
      if (
        ...
        error.response.data.message === "Voter already voted"
      ) {
  ...
  return (
    <div className="bg-blue-200">
      ...
      <button
        onClick={logout}
        class=" float-right group flex items-center justify-start w-11 h-11 bg-red-600 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1"
      >
