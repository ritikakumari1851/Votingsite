...
export default function Registration() {
  ...
  function handleRegister(e) {
    ...
    fetch("https://voteonclickbackend.onrender.com/register", {
      method: "POST",
      headers: {
          ...
          <div class="relative px-4 py-10 bg-black mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
            ...
            <div class="max-w-md mx-auto text-white">
              ...
              <div class="flex items-center justify-between mt-4">
                ...
                <p class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">
                  {" "}
                  <Link to={"/Login"}> already have an account? Log in </Link>
                </p>
                <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
              </div>
              <p class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline text-center">
                {" "}
                <Link to={"/voteregister"}> Register as a Voter</Link>
              </p>
            </div>
          </div>
        </div>
