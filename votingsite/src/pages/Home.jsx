      ...
      <div className="flex flex-col md:flex-row justify-between h-80 w-full border bg-orange-600 md:p-10 mt-5">
        ...
        <div className=" flex flex-col">
          ...
          <div className=" text-white font-semibold text-lg md:w-full ml-2 mr-7  ">
            Voters can only vote once and voting choices remain anonymous. Each
            ballot has one, secure voting key and the vote is auditable,
        ...
        <div className=" flex flex-col">
          ...
          <div className=" text-white font-semibold text-lg md:w-full ml-4 ">
            Vote on executive officers, board positions, contract ratifications,
            bylaw amendments, budget approvals, acclamations and motions. Or run
            polls and surveys.
            <br />
            <br />
          </div>
      ...
      <div className="flex flex-col md:flex-row justify-between h-80 w-full border bg-white md:p-10">
        ...
        <div className=" flex flex-col">
          ...
          <div className=" text-gray-500 md:w-full font-semibold text-lg ml-2 mr-7 ">
            ...
            cumulative voting, preferential ballot, STV Single transferable vote
            or approval voting. You can tabulate results yourself too!
            <br />
            <br />
          </div>
        </div>
      ...
      <body class="font-sans flex flex-row bg-gray-100">
        <div class="flex flex-col font-bold font-serif items-center justify-center h-auto bg-orange-600">
          ...
          <p className=" text-white text-lg font-normal ml-5">
            Just answer a few questions, and we'll guide you through the set up
            of your vote.
          </p>
        ...
        <div class="flex flex-col font-bold  font-serif items-center justify-center h-auto bg-green-500">
          ...
          <br />
          <p className=" text-white text-lg font-normal ml-5">
            Get advice and answers as you go, with a final Expert review before
            voting starts.
          </p>
        ...
        <div class="flex flex-col font-bold  font-serif items-center justify-center h-auto bg-orange-600">
          ...
          <br />
          <p className=" text-white text-lg font-normal ml-5">
            Have a dedicated Expert do it all remotely or onsite, from the start
            of voting to results.
          </p>
