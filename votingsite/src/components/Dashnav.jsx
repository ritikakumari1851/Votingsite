...
export default function Dashnav() {
  ...
  return (
    ...
    <div className=' flex flex-col bg-gray-800 py-5  h-screen text-xl text-gray-400 w-[32vh] shadow-2xl'>
    ...
    <p className=' font-serif font-bold hover:text-white'>Onclick</p>
        ...
        <div className=' flex flex-col'>
            ...
            <p className=' pb-6 hover:text-white'><Link to={'/profile'}>Edit profile</Link></p>
