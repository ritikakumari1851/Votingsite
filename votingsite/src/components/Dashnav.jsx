    ...
    <div className='flex flex-col justify-between'>
      <div className='flex flex-col bg-gray-800 py-5 h-full text-xl text-gray-400 w-[32vh] shadow-2xl'>
        <div className='flex flex-row items-center mb-4 pl-4 border-b pb-2 border-gray-400'>
          ...
          <p className='font-display font-bold hover:text-white'><b className=' text-3xl text-black'>V</b>ote <b className=' text-3xl text-black'>O</b>nclick</p>
        </div>
            ...
            <div className='flex flex-col font-serif'>
              <p className='pt-4 pb-4 hover:bg-blue-950 hover:text-white'>
                <Link to={'/dashboard'} className='flex items-center'>
                  <img src={img3} alt='' className='w-10 h-10 mr-2 ml-2' />
                  Dashboard
                </Link>
              </p>
              <p className='pb-4 pt-4 hover:bg-blue-950 hover:text-white'>
                <Link to={'/Ballot'} className='flex items-center'>
                  <img src={img6} alt='' className='w-10 h-10 mr-2 ml-2' />
                  Ballot
                </Link>
              </p>
              <p className=' pt-4 pb-4 hover:bg-blue-950 hover:text-white'>
                <Link to={'/voiting'} className='flex items-center'>
                  <img src={img1} alt='' className='w-10 h-10 mr-2 ml-2' />
                  Voting
                </Link>
              </p>
              <p className=' pt-4 pb-4 hover:bg-blue-950 hover:text-white'>
                <Link to={'/voiting'} className='flex items-center'>
                  <img src={img2} alt='' className='w-10 h-10 mr-2 ml-2' />
                  Pricing
                </Link>
              </p>
            </div>
