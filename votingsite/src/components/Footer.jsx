...
export function MyFooter() {
  ...
  if (location.pathname === '/Login' || location.pathname === '/registration' || location.pathname === '/Reset' || location.pathname === '/Contact' || location.pathname === '/forgotpas' || location.pathname === '/dashboard' ) {
   return null;
  } 
